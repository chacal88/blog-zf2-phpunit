...
class IndexControllerTest extends ControllerTestCase
{
    ...
    /**
     * Testa o acesso a uma action que nÃ£o existe
     */
    ...
    /**
 * Testa a pÃ¡gina inicial, que deve mostrar os posts
 */
...
/**
 * Testa a pÃ¡gina inicial, que deve mostrar os posts com paginador
 */
public function testIndexActionPaginator()
{
    ...
    //testa a terceira pÃ¡gina da paginaÃ§Ã£o
    $this->routeMatch->setParam('action', 'index');
